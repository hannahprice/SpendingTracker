...
namespace SpendingTracker.Server.Migrations
{
    ...
    [Migration("20220810204321_single-category")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SpendingTracker.Shared.Models.Budget", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SpendingTracker.Shared.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SpendingTracker.Shared.Models.Subcategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SpendingTracker.Shared.Models.Transaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BudgetSubcategory", b =>
                {
                    b.HasOne("SpendingTracker.Shared.Models.Budget", null)
                        .WithMany()
                        .HasForeignKey("BudgetsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SpendingTracker.Shared.Models.Subcategory", null)
                        .WithMany()
            ...
            modelBuilder.Entity("SpendingTracker.Shared.Models.Budget", b =>
                {
                    b.HasOne("SpendingTracker.Shared.Models.Category", "Category")
                        .WithMany("Budgets")
            ...
            modelBuilder.Entity("SpendingTracker.Shared.Models.Subcategory", b =>
                {
                    b.HasOne("SpendingTracker.Shared.Models.Category", null)
            ...
            modelBuilder.Entity("SubcategoryTransaction", b =>
                {
                    ...
                    b.HasOne("SpendingTracker.Shared.Models.Transaction", null)
                        .WithMany()
